...
#Hiwonder iic ultrasonic using routine#
...
class Sonar:
    ...
    #set the light mode. 0 is colored light mode. 1 is breathing light mode
    def setRGBMode(self, mode):
        with SMBus(self.i2c) as bus:
            bus.write_byte_data(self.i2c_addr, self.__RGB_MODE, mode)
    
    #set color of the light 
    #parameter 1: 0 represents the left light and 1 represents the right light
    #parameter 2: rgb ratio value of color, passed in tuple. The range is 0-255. The order is r, g, b.
    ...
    #parameter 1: 0 represents the left light and 1 represents the right light
    #parameter 2: color channel. 0 represents r, 1 represents g and 2 represents b
    #parameter 3: change peroid of color in ms
    ...
    #acquire distance. The unit is mm
